  ...
  methods: {
    ...
    register() {
      if(this.validate()){
        ...
        this.$axios.pacth(`https://liffcard-default-rtdb.asia-southeast1.firebasedatabase.app/members/${this.$store.getters.getLine.userId}/profile.json`, this.$store.getters.getRegister).then((res) => {
